...
pJS.particles.number.value = 200; // Reduced from 400
pJS.particles.number.density.value_area = 1200; // Increased from 800
pJS.particles.size.value = 15; // Reduced from 20
pJS.particles.opacity.value = 0.7; // Reduced from 1
pJS.particles.line_linked.distance = 80; // Reduced from 100
pJS.particles.line_linked.opacity = 0.7; // Reduced from 1
